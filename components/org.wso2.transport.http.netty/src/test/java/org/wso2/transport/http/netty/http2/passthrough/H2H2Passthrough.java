...
/**
 * Test case for HTTP/2-HTTP/2 passthrough scenario. Intermediate client uses the prior knowledge feature.
 */
public class H2H2Passthrough {
    ...
    private void startBackEndServer() {
        ...
        backEndServer = httpWsConnectorFactory
                .createServerConnector(new ServerBootstrapConfiguration(new HashMap<>()), listenerConfiguration);
