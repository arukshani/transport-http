...
//                                LOG.warn("Before writing h2 request. Is channel writable {}",
//                                        activeHttp2ClientChannel.getChannel().isWritable());
                                activeHttp2ClientChannel.getChannel().writeAndFlush(outboundMsgHolder);
